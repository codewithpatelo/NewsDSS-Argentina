...
// Herramientas de procesamiento y algoritmica.
...
objetividad.addDocument('', 'objetivo');
objetividad.addDocument('', 'objetivo');
objetividad.addDocument('', 'objetivo');
objetividad.addDocument('', 'objetivo');
objetividad.addDocument('', 'objetivo');
...
objetividad.addDocument('', 'subjetivo');
objetividad.addDocument('', 'subjetivo');
objetividad.addDocument('', 'subjetivo');
...
asertividad.addDocument('', 'asertivo');
asertividad.addDocument('', 'agresivo');
asertividad.addDocument('', 'pasivo');
...
verificabilidad.addDocument('', 'noVerificable');
verificabilidad.addDocument('', 'noVerificable');
verificabilidad.addDocument('', 'noVerificable');
verificabilidad.addDocument('', 'noVerificable');
...
argumentatividad.addDocument('', 'argumentado');
argumentatividad.addDocument('', 'argumentado');
argumentatividad.addDocument('', 'argumentado');
argumentatividad.addDocument('', 'argumentado');
argumentatividad.addDocument('', 'argumentado');
...
argumentatividad.addDocument('', 'desargumentado');
argumentatividad.addDocument('', 'desargumentado');
argumentatividad.addDocument('', 'desargumentado');
argumentatividad.addDocument('', 'desargumentado');
  ...
  https.get(url, (resp) => {
    ...
    resp.on('end', () => {
	  ...
	  // Computamos accesibilidad...
		...
		let readability = Math.round((doc.ifsz().get() / 100)) * 10;
	...
	// (Cantidad de fuentes. (Máx 5) / 5) en un index 1/10
      ...
      const criterias = [
        {
          ...
          weight: 0.40,
          rating: response.objetividad * 0.4,
          rank: 0,
        }, {
          name: 'Accesibilidad',
          ...
          weight: 0.10,
          rating: response.accesibilidad * 0.10,
          rank: 0,
        }, {
          ...
          weight: 0.30,
          rating: response.verificabilidad * 0.3,
          rank: 0,
        }, {
          name: 'Confibilidad',
          ...
          score: response.accesibilidad,
          weight: 0.20,
          rating: response.accesibilidad * 0.20,
          rank: 0,
        },
	 ...
	 // Calculamos puntaje final.	  
	  ...
	  let tiempoLectura = Math.round(doc.readingTime());
